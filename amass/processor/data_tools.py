...
import copy
import os
from amass.amass_handler import AMASSDataProcessor
...
def amass_define_actions(data_path):
...
def get_srnn_gts(actions, data_set, data_mean, data_std, dim_to_ignore,
    ...
    for action in actions:
        srnn_gt = []
        encoder_inputs, decoder_inputs, targets = srnn_sample(data_set, action, source_seq_len, target_seq_len,
                                                              input_size)
