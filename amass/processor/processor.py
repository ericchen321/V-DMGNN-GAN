...
class Processor(IO):
    ...
    def load_data(self):
        ...
        self.actions = amass_define_actions(data_path=self.arg.test_dir)
        ...
        # # ================== ACCAD =====================
        # self.train_dict = load_pkl(self.arg.train_dir)
        # self.test_dict = load_pkl(self.arg.test_dir)
        ...
        #
        # self.actions = list(self.train_dict.keys())
        #
    ...
    def start(self):
        ...
        if self.arg.phase == 'train':
            ...
            for itr in range(self.arg.iter_num):
                ...
                if ((itr + 1) % self.arg.eval_interval == 0) or (itr + 1 == self.arg.iter_num):
                    ...
                    self.test(iter_time=itr // self.arg.eval_interval, save_motion=save_motion,
                              actions=list(self.test_dict.keys()))
            ...
            for idx, action in enumerate(self.actions):
                print_str = "{0: <16} |".format(action[0])
    ...
    def get_parser(add_help=False):
        ...
        parser.add_argument('--savemotion_interval', type=int, default=2000000000000,
                            help='the interval for evaluating models (#iteration)')
